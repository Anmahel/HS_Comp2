    ...
    <div className="space-y-4">
      ...
      <div className="rounded-2xl bg-dark-800/90 border border-slate-800 shadow-lg overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs" data-testid="tabela-estampas">
            <thead className="bg-dark-900/80 text-slate-400 uppercase font-mono text-[10px] border-b border-slate-700/80">
              <tr>
                ...
                <th className="px-4 py-3">
                  <button
                    type="button"
                    data-testid="sort-codigo-btn"
                    onClick={() => handleSort('codigo_estampa')}
                    className="flex items-center gap-1.5 hover:text-white transition-colors group"
                  >
                    <span>Cód. Estampa</span>
                    <ArrowUpDown className="h-3 w-3 text-slate-500 group-hover:text-rose-400" />
                  </button>
                </th>
                <th className="px-4 py-3">
              ...
              {loading ? (
                <tr>
                  <td colSpan={7} className="px-4 py-12 text-center text-slate-400">
                    ...
                    <p className="font-mono text-xs">Carregando estampas...</p>
                  </td>
                </tr>
                ...
                filteredAndSortedItems.map((item) => (
                  <tr
                    key={item.id}
                    data-testid={`row-estampa-${item.id}`}
                    ...
                    <td className="px-4 py-3 text-center">
                      <div className="flex items-center justify-center gap-1.5">
                        <button
                          ...
                          onClick={() => onOpenDeduct(item, 'estampa')}
                        ...
                        <button
                          type="button"
                          title="Editar item"
                          onClick={() => onOpenEdit(item, 'estampa')}
                ...
                <tr>
                  <td colSpan={7} className="px-4 py-12 text-center text-slate-500 text-xs">
                    Nenhuma estampa avulsa encontrada com os filtros selecionados.
                  </td>
                </tr>
              )}
            </tbody>
